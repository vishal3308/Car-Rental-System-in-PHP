            ...
            <div class="row">
                <div class="adduser">
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="email" name="email" onblur="blurfunction(this)" required autocomplete="off">
                        <div class="line"></div>
                        ...
                        <div class="input">
                            <a href="Agencysignup.php" class="link">Sign Up as Agency member</a>
                ...
                <!-- --------------------------------Script-------------+ -->
                  ...
                  <?php
                    if(isset($_POST['submit'])){
                        ...
                        echo " <div class='failed' style='margin-top:5px;'><p> *Email already exist.</p></div>";
                        }
                        else{
